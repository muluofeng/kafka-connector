...
//    }
    ...
    @KafkaListener(id = "d2", topics = {"test.mybatis-demo.users"})
    public void listener2(ConsumerRecord<String, String> record) throws Exception {
        listener(record);
    }

    @KafkaListener(id = "d1", topics = {"test.mybatis-demo.users"})
